  ...
  >
    ...
    <g clipPath="url(#ni-c)" transform="matrix(.8 0 0 .8 -80 0)">
      ...
      <g id="ni-e">
        ...
        <use width="100%" height="100%" transform="rotate(72 500 285.5)" />
        <use width="100%" height="100%" transform="rotate(144 500 285.5)" />
        <use width="100%" height="100%" transform="rotate(-144 500 285.5)" />
        <use width="100%" height="100%" transform="rotate(-72 500 285.5)" />
      </g>
      <use width="100%" height="100%" transform="rotate(8 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(16 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(24 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(32 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(40 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(48 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(56 500 285.5)" />
      <use width="100%" height="100%" transform="rotate(64 500 285.5)" />
      <path
        fill="red"
      ...
      <g fill="url(#ni-h)">
        ...
        <g id="ni-n" fill="url(#ni-i)">
          ...
          />
          <use width="100%" height="100%" y="-1.1" fill="url(#ni-l)" />
          <use width="100%" height="100%" y="-2.2" fill="url(#ni-m)" />
        </g>
        <use width="100%" height="100%" y="-3.3" fill="url(#ni-o)" />
        <use width="100%" height="100%" y="-6.7" fill="url(#ni-p)" />
        <path
          fill="url(#ni-q)"
      ...
      <g fill="#ccd11e">
        ...
        <use width="100%" height="100%" x="-15.3" />
        <g fill="#c6cb24">
          <path
            fill="url(#ni-u)"
        ...
        <use width="100%" height="100%" x="-15.4" fill="#c6cb24" />
      </g>
      <path
        fill="#fff"
      ...
      <g id="ni-A">
        ...
        />
        <use width="100%" height="100%" y="-1.3" />
        <use width="100%" height="100%" y="-2.6" />
      </g>
      <use width="100%" height="100%" y="-3.9" />
      <use width="100%" height="100%" y="-7.7" />
      <path
        fill="#97c924"
